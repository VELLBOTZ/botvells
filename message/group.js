...
autoWelcome = JSON.parse(fs.readFileSync('./settings.json')).autoWelcome
...
//Welcome Type1
             ...
             if (anu.action == "add" && welcomeType1) {
             ...
             sendButImage2(from, intro, copyright, buff, buttons)
              ...
              if (anu.action == "remove" && welcomeType1 ) {
...
//welcome Type2          
             ...
             if (anu.action == "add" && welcomeType2) {     
             ...
             sendButImage2(from, intro, copyright, buff, buttons)
              ...
              if (anu.action == "remove" && welcomeType2) {       
...
//Welcome Type3   
             ...
             if (anu.action == "add" && welcomeType3) {       
             ...
             sendButLocation(from, intro, copyright, ppUser, buttons)
              ...
              if (anu.action == "remove" && welcomeType3){      
